...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB14     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(GPIOA, VS_HV_Pin|VS_12_Pin);

    HAL_GPIO_DeInit(VS_5_GPIO_Port, VS_5_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PC4     ------> ADC2_IN5
    */
    HAL_GPIO_DeInit(GPIOC, TEMP8_Pin|TEMP6_Pin|TEMP7_Pin|TEMP9_Pin
                          |TEMP5_Pin);

    HAL_GPIO_DeInit(GPIOA, TEMP2_Pin|TEMP1_Pin|TEMP3_Pin|TEMP4_Pin);
  ...
  else if(hadc->Instance==ADC3)
  {
    ...
    PE13     ------> ADC3_IN3
    */
    HAL_GPIO_DeInit(GPIOE, EA2_Pin|EA3_Pin);

    HAL_GPIO_DeInit(EA1_GPIO_Port, EA1_Pin);
  ...
  else if(hadc->Instance==ADC4)
  {
    ...
    PB12     ------> ADC4_IN3
    */
    HAL_GPIO_DeInit(GPIOE, EA5_Pin|EA4_Pin);

    HAL_GPIO_DeInit(EA6_GPIO_Port, EA6_Pin);
  ...
  else if(hadc->Instance==ADC5)
  {
    ...
    PD11     ------> ADC5_IN8
    */
    HAL_GPIO_DeInit(GPIOD, EA8_Pin|EA9_Pin);

    HAL_GPIO_DeInit(EA7_GPIO_Port, EA7_Pin);
...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* hfdcan)
{
  if(hfdcan->Instance==FDCAN1)
  {
    ...
    PD0     ------> FDCAN1_RX
    */
    HAL_GPIO_DeInit(GPIOD, CAN_TX_Pin|CAN_RX_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==UART4)
  {
    ...
    PC10     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOC, RX_E_Pin|TX_E_Pin);
  ...
  else if(huart->Instance==USART1)
  {
    ...
    PE0     ------> USART1_TX
    */
    HAL_GPIO_DeInit(GPIOE, RX_W_Pin|TX_W_Pin);
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PD5     ------> USART2_TX
    */
    HAL_GPIO_DeInit(GPIOD, RX_N_Pin|TX_N_Pin);
  ...
  else if(huart->Instance==USART3)
  {
    ...
    PB10     ------> USART3_TX
    */
    HAL_GPIO_DeInit(RX_S_GPIO_Port, RX_S_Pin);

    HAL_GPIO_DeInit(TX_S_GPIO_Port, TX_S_Pin);
